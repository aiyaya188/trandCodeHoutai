...
jQuery(function () {
    ...
    uploader = WebUploader.create({
        ...
        accept: {
            title: 'Files',
            extensions: 'rmvb,flv,vob,mp4,mov,3gp,wmv,mp3,mkv,mpg,ts,avi,mpeg,avi,rm,wav,asf,divx,mpg,mpe,vod,mts',
    ...
    uploader.on('fileQueued', function (file) {
        jQuery('.webuploader-pick,input[type="file"]').attr('disabled','disabled');
        jQuery('#chosevideo,.webuploader-pick,input[type="file"]').off();
