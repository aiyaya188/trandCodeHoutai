...
<div class="page-container">
    <div class="pd-20">
        <form method="POST" action="{{ url('admin/domain_name') }}">
            {{ csrf_field() }}
            <div >
                播放域名： <input align = "center" name="domain_name_setting" class="textarea" value="{{$domain_name ?? '请设置播放域名'}}" style="width:40%; height:40px; resize:none">
            </div>
